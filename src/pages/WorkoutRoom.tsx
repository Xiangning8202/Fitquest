...
export function WorkoutRoom() {
  ...
  return (
    <div className="h-dvh sm:h-full bg-gray-950 flex flex-col">
      ...
      {started && (
        <div className="fixed left-0 right-0 bottom-0 z-30 sm:relative sm:bottom-auto sm:left-auto sm:right-auto flex-shrink-0 bg-gray-950/90 backdrop-blur-md border-t border-gray-800 px-4 pt-4 pb-10 space-y-3 nav-safe">
